...
> If you see `unrecognized arguments: --rows --cols --seed`, you are likely running an older installed script.
> Re-run using `python python_demos/ising_heatmap_gif.py ...` or reinstall with `pip install -e . --no-build-isolation`.
