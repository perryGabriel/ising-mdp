...
```bash
python .\python_demos\stage3_analyze\renormalization_operator_demo.py --artifact-prefix artifacts --rows 4 --cols 4 --steps 20 --seed 7 --output-csv artifacts/operator/renormalization_operator.csv --output-plot artifacts/operator/renormalization_operator.png
```
...
```bash
python .\python_demos\stage4_report\run_report_pipeline.py --artifact-prefix artifacts --rows 4 --cols 4 --steps 20 --seeds 30
