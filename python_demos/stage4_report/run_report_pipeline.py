...
def main() -> None:
    ...
    run(
        [
            sys.executable,
            "python_demos/stage1_generate/ising_magnetization_compare.py",
            "--artifact-prefix",
    ...
    run(
        [
            sys.executable,
            "python_demos/stage2_map/fit_parameter_map.py",
            "--artifact-prefix",
            args.artifact_prefix,
            "--source-model",
            args.source_model,
    ...
    if not args.skip_plots:
        run(
            [
                sys.executable,
                "python_demos/stage3_analyze/plot_magnetization_manifold.py",
                "--artifact-prefix",
                args.artifact_prefix,
                "--source-model",
                args.source_model,
        ...
        run(
            [
                sys.executable,
                "python_demos/stage3_analyze/visualize_trajectory_matching.py",
                "--artifact-prefix",
                args.artifact_prefix,
                "--source-model",
                args.source_model,
    ...
    run(
        [
            sys.executable,
            "python_demos/stage3_analyze/renormalization_operator_demo.py",
            "--artifact-prefix",
            args.artifact_prefix,
            "--rows",
            str(args.rows),
    ...
    run(
        [
            sys.executable,
            "python_demos/stage4_report/generate_figure_manifest.py",
            "--artifact-prefix",
            args.artifact_prefix,
            "--output",
